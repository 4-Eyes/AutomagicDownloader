...
namespace MediaAPIs.IMDb
{
    ...
    {
        [Description("General Audiences")] [Detail("All ages admitted. Nothing that would offend parents for viewing by children.")] G,

        [Description("Parental Guidance")] [Detail(
            "Some material may not be suitable for children. Parents urged to give \"parental guidance\". May contain some material parents might not like for their young children."
            )] PG,

        [Description("Parental Guidance 13")] [Detail(
        ...
        [Description("Adults Only")] [Detail("No One 17 and Under Admitted. Clearly adult. Children are not admitted.")] NC17
    }
    ...
    public enum NZMovieClassification
    {
        ...
        [Description("Restricted 13")] [Detail("Restricted to people over the age of 13")] R13,
        [Description("Restricted 15")] [Detail("Restricted to people over the age of 15")] R15,
        [Description("Restricted 16")] [Detail("Restricted to people over the age of 16")] R16,
        [Description("Restricted 18")] [Detail("Restricted to people over the age of 18")] R18
    }

    internal class Detail : Attribute
    {
        public string Text;
    ...
    public static class ClassificationHelper
    {
        ...
        {
            foreach (
                var usClassification in
                    Enum.GetValues(typeof(USMovieClassification))
                        .Cast<object>()
                        .Where(
                            usClassification1 =>
                                classificationString.Replace("-", "").Contains(usClassification1.ToString()))
                        .OrderBy(
            ...
            foreach (
                var nzClassification in
                    Enum.GetValues(typeof(NZMovieClassification))
                        .Cast<object>()
                        .Where(nzClassification1 => classificationString.Contains(nzClassification1.ToString())))
            {
